...
| The [networkd files](https://github.com/agoodkind/configs/tree/8693b22f892bc745fa16631e4b1fc874fb9ee53e/mwan/networkd) and [`nftables.conf.j2`](https://github.com/agoodkind/configs/blob/8693b22f892bc745fa16631e4b1fc874fb9ee53e/mwan/config/nftables.conf.j2) | mixed, and deleted by `MWAN-341` and `MWAN-397` when the daemon programs the kernel directly | `configs` until then; not moved |
