...
| --- | --- | --- | --- |
| Tayga (NAT64 translator) | testbed OPNsense, `os-tayga` plugin | v6 prefix `3d06:bad:b01:2664::/96`, tun `nat64`, v4 pool `10.250.64.0/24` | `<tayga>` block in the imported `config.xml` (prod prefix `3d06:bad:b01:6464::/96` rewritten to `3d06:bad:b01:2664::/96` by the config transform) |
