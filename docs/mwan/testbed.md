...
| vmbr2  | MWAN internal (OPNsense)   | Transit link, `10.240.240.0/29` and `3d06:bad:b01:201::/64`. Suburban holds no address here, matching vault, so it reaches the guests through OPNsense rather than across the bridge. |
