...
| `enmbrains0` | Monkeybrains | `158.247.70.19/26` (public) | SLAAC `2607:f598:d3e0:131::/64` plus DHCPv6-PD `2607:f598:d3e8:4500::/56` | 5000 (tertiary) | NPT maps the internal `/60` onto the PD's first `/60`. The PD renumbers, so the live delegation drives the prefix. Not in the health-check set. |
